# Generated by Django 5.2 on 2025-08-21 12:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('employee_portal', '0002_initial'),
        ('employer_portal', '0001_initial'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('pending', 'Pending'), ('reviewed', 'Reviewed'), ('interview_scheduled', 'Interview Scheduled'), ('interview_completed', 'Interview Completed'), ('shortlisted', 'Shortlisted'), ('rejected', 'Rejected'), ('withdrawn', 'Withdrawn')], default='pending', max_length=30)),
                ('applied_at', models.DateTimeField(auto_now_add=True)),
                ('withdrawn', models.BooleanField(default=False)),
                ('withdrawn_at', models.DateTimeField(blank=True, null=True)),
                ('withdraw_reason', models.TextField(blank=True, null=True)),
                ('candidate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='employee_portal.personalinformation')),
                ('company', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='employer_portal.companyinformation')),
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='job_applications', to='employer_portal.jobdetails')),
            ],
            options={
                'ordering': ['-applied_at'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interviewer_job_role', models.CharField(blank=True, max_length=255, null=True)),
                ('interviewer_linkedin_profile', models.URLField(blank=True, help_text='Linkedin profile URL', null=True)),
                ('interviewer_github_profile', models.URLField(blank=True, help_text='GitHub profile URL', null=True)),
                ...
                ('attachment', models.FileField(blank=True, null=True, upload_to='interview_attachments/')),
                ('attachment_description', models.TextField()),
                ('candidate_confirmation', models.BooleanField(default=False)),
                ('candidate_confirmation_deadline', models.DateTimeField(blank=True, null=True)),
                ...
                ('candidate', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='employee_portal.personalinformation')),
                ('company', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='employer_portal.companyinformation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offer_document', models.FileField(blank=True, null=True, upload_to='')),
                ...
                ('candidate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='received_offers', to='employee_portal.personalinformation')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sent_offers', to='employer_portal.companyinformation')),
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='employer_portal.jobdetails')),
            ],
        ),
        migrations.CreateModel(
            name='JobShare',
            fields=[
                ...
                ('platform', models.CharField(choices=[('email', 'Email'), ('facebook', 'Facebook'), ('twitter', 'X'), ('linkedin', 'LinkedIn'), ('whatsapp', 'WhatsApp'), ('other', 'Other')], default='other', max_length=20)),
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='job_shares', to='employer_portal.jobdetails')),
                ('shared_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='employee_portal.personalinformation')),
            ],
        ),
        migrations.CreateModel(
            name='JobImpression',
            fields=[
                ...
                ('candidate', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='employee_portal.personalinformation')),
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='job_impressions', to='employer_portal.jobdetails')),
            ],
            options={
                'ordering': ['-timestamp'],
                'unique_together': {('job', 'candidate')},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rating', models.PositiveIntegerField(choices=[(1, 'Very Poor'), (2, 'Poor'), (3, 'Average'), (4, 'Good'), (5, 'Excellent')], default=1)),
                ('title', models.CharField(max_length=100)),
                ('comment', models.TextField()),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('candidate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='employee_portal.personalinformation')),
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='job_ratings', to='employer_portal.jobdetails')),
            ],
            options={
                'ordering': ['-timestamp'],
                'unique_together': {('job', 'candidate')},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='job_views', to='employer_portal.jobdetails')),
                ('viewer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='employee_portal.personalinformation')),
            ],
            options={
                'ordering': ['-viewed_at'],
